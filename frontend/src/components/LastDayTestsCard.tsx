...
export default function LastDayTestsCard({ tests }: LastDayTestsCardProps) {
    return (
        <>
            <div className='d-flex flex-column' style={{ backgroundColor: 'transparent', overflowY: 'auto' }}>
                <h5
            ...
            <div className='d-flex flex-column h-100' style={{ backgroundColor: 'transparent', maxHeight: '200px', overflowY: 'auto' }}>
                {tests.length === 0 ? (
